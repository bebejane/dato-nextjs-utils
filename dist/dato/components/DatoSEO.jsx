...
const DatoSEO = ({ seo = {}, site = {}, pathname, title, subtitle, description, noindex = false }) => {
    ...
    return (<NextSeo title={title} description={description} canonical={url} openGraph={{
            url,
            title,
            description,
            images,
        ...
        }} twitter={twitterProps} additionalLinkTags={favicons} noindex={noindex} nofollow={noindex}/>);
};
