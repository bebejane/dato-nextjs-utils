...
export default function withWebPreviewsEdge(generatePreviewUrl) {
    const corsOptions = {
        origin: '*',
    ...
    return async (req, res) => {
        ...
        return cors(req, new Response(JSON.stringify({ previewLinks }), {
            status: 200,
            headers: { 'Content-Type': 'application/json' },
        }), corsOptions);
    };
}
//# sourceMappingURL=withWebPreviewsEdge.js.map